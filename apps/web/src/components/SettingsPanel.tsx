      ...
      <div className="max-w-2xl mx-auto px-6 py-6 space-y-5">
        ...
        <Card title="About Jarvis">
          ...
          <div className="flex items-center gap-2 py-1.5">
            ...
            <MonoValue>v{settings?.appVersion ?? "1.4.3"}</MonoValue>
        ...
        <Card title="Feature Status">
          ...
          <SettingRow label="Workspace overview file deep-link">
            <Badge variant="done" />
          </SettingRow>
          <SettingRow label="Workspace overview auto-refresh after writes">
            <Badge variant="done" />
          </SettingRow>
        ...
        <p className="text-xs text-slate-600 text-center pb-2">
          Jarvis v{settings?.appVersion ?? "1.4.3"} — local-first AI assistant ·
